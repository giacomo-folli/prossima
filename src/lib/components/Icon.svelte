<script lang="ts">
	...
	/* ── Lucide-compatible SVG paths (outline, 24×24 viewBox) ── */
	const icons: Record<string, string> = {
		...
		"chart-column":
			'<path d="M3 3v16a2 2 0 0 0 2 2h16"/><rect x="18" y="5" width="3" height="12" rx="1"/><rect x="12" y="9" width="3" height="8" rx="1"/><rect x="6" y="13" width="3" height="4" rx="1"/>',
		settings:
		...
		sparkles: '<path d="M12 3v16M19 12H5M12 3l-1.9 5.8a2 2 0 0 1-1.3 1.3L3 12l5.8 1.9a2 2 0 0 1 1.3 1.3L12 21l1.9-5.8a2 2 0 0 1 1.3-1.3L21 12l-5.8-1.9a2 2 0 0 1-1.3-1.3L12 3Z"/>',
		"circle-minus": '<circle cx="12" cy="12" r="10"/><path d="M8 12h8"/>',
		bolt: '<path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/>',
		"list-check": '<path d="M11 12H3"/><path d="M16 6H3"/><path d="M16 18H3"/><path d="m19 10-3 3-1.5-1.5"/>',
		stack: '<path d="m12 3-10 5 10 5 10-5-10-5Z"/><path d="m2 17 10 5 10-5"/><path d="m2 12 10 5 10-5"/>',
		"mood-puzzled": '<circle cx="12" cy="12" r="10"/><path d="M16 16s-1.5-2-4-2-4 2-4 2"/><line x1="9" x2="9.01" y1="9" y2="9"/><line x1="15" x2="15.01" y1="9" y2="9"/>',
